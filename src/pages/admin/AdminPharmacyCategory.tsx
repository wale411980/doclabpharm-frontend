...
import {
  useGetAdminPharmacyMedicineCategories,
  useGetAdminPharmacyMedicineCategoriesById,
  useAddAdminPharmacyMedicineCategory,
  useUpdateAdminPharmacyDiagnosisByCategory,
  useDeleteAdminPharmacyDiagnosisByCategory,
} from "@/queries";
...
export default function AdminPharmacyCategory() {
  ...
  const [, setManagementCategories] =
    useState<AdminPharmacyMedicineCategory[]>();
  ...
  } = useGetAdminPharmacyMedicineCategoriesById(expandedCategoryId ?? 0, {
