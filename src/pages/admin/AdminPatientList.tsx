...
import {
  useAdminPatientList,
  useAdminUpdatePatient,
  useAdminDeletePatient,
  useAdminPatientStats,
} from "@/queries";
import type { AdminPatientUpdate } from "@/types";
...
export default function AdminPatientList() {
  ...
  const [editingPatient, setEditingPatient] =
    useState<AdminPatientUpdate | null>(null);
  ...
  const { data: patientStats } = useAdminPatientStats();
  const { mutate: updatePatient } = useAdminUpdatePatient();
  const { mutate: deletePatient } = useAdminDeletePatient();
  ...
  const handleEditPatient = (patient: AdminPatientUpdate) => {
