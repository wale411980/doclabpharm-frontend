...
import { useAdminAllDoctorAppointments } from "@/queries";
import type { AdminRecentAppointments } from "@/types";
...
export default function AdminDoctorAppointments() {
  ...
  const { data: allAppointments, isLoading } = useAdminAllDoctorAppointments();
            ...
            <div className="block md:hidden">
              <div className="space-y-4 p-4">
                {paginatedAppointments?.map(
                  (appointment: AdminRecentAppointments) => (
