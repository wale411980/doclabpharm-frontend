...
import type { PharmacyWalletHistories, BankAccount, Withdraw } from "@/types";
            ...
            <Card className="bg-green-700 text-white py-4">
              ...
              <CardContent>
                <div className="text-4xl font-bold mb-2">
                  ₦ {pharmacyWallet.balance?.toLocaleString()}
                </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {paginatedHistories?.map(
                      (transaction: PharmacyWalletHistories) => (
