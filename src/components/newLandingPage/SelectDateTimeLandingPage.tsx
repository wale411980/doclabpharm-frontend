...
export default function SelectDateTimeLandingPage() {
  ...
  const bookingData = JSON.parse(localStorage.getItem("testBooking") || "{}");
  ...
  const handleContinue = () => {
    ...
    // ✅ Add query params for page navigation
    const params = new URLSearchParams({
      testId: String(bookingData.id),
      testName: bookingData.name,
      testPrice: String(bookingData.price),
    ...
    navigate(`/patient/bookings/confirm?${params.toString()}`);
  };
        ...
        <Card className="bg-green-100/50 border-green-200">
          <CardContent className="p-4 sm:p-6 md:p-8">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <Card className="bg-green-200/30 border-green-300 mt-6">
