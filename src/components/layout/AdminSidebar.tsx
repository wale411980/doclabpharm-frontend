...
export function AdminSidebar({ onClose }: SidebarProps) {
  ...
  const navItems = [
    ...
    { icon: User, label: "Lab Technicians", href: "/admin/labs" },
    { icon: User, label: "Pharmacists", href: "/admin/pharmacists" },
    { icon: User, label: "Drug Category", href: "/admin/category" },
    { icon: ReceiptText, label: "Transactions", href: "/admin/transactions" },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      href: "/admin/lab-appointments",
    },
    { icon: FileText, label: "Lab Diagnosis", href: "/admin/lab-diagnosis" },
  ...
  const handleSignOut = async () => {
    try {
      await logout();
      window.location.href = "/admin/login"; // 🔁 Hard reload of the page
    } catch (error) {
